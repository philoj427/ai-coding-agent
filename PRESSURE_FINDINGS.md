...
- This remained the dominant failure mode, and the shorter anchors did not improve the pass rate in this rerun.
...
- Short anchors alone did not solve search-text alignment.
