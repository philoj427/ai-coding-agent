...
- V1.9 adds plan-only handling for high-risk tasks and a harder 50-task planning suite.
...
- `pressure_tasks_v19.txt` is the next harder suite; it includes patchable tasks, plan-only protected-file tasks, and ambiguous plan-failed tasks.
...
- Treat V1.9 plan-only outcomes separately from patch success outcomes.
